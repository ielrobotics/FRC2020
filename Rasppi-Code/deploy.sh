...
ssh pi@10.80.58.254 "systemctl --user stop image-recognition && rm -rf /home/pi/Rasppi-Code && tar -xf rasppi-code-image.tar.gz && rm rasppi-code-image.tar.gz && sudo mkfifo /home/pi/Rasppi-Code/logfile && sudo chown pi:pi /home/pi/Rasppi-Code/logfile && systemctl --user start image-recognition"
